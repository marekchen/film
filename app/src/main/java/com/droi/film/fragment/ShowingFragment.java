...
public class ShowingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        filmBean.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2390687452.jpg");
        ...
        filmBean2.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2404720316.jpg");

        FilmBean filmBean3 = new FilmBean();
        filmBean3.setTitle("长城");
        filmBean3.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2394573821.jpg");

        FilmBean filmBean4 = new FilmBean();
        filmBean4.setTitle("血战钢锯岭");
        filmBean4.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2397337958.jpg");

        FilmBean filmBean5 = new FilmBean();
        filmBean5.setTitle("罗曼蒂克消亡史");
        filmBean5.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2404553168.jpg");

        FilmBean filmBean6 = new FilmBean();
        filmBean6.setTitle("你的名字。");
        filmBean6.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2395733377.jpg");

        FilmBean filmBean7 = new FilmBean();
        filmBean7.setTitle("绝对控制");
        filmBean7.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2405285938.jpg");

        FilmBean filmBean8 = new FilmBean();
        filmBean8.setTitle("海洋奇缘");
        filmBean8.setImages("http://img3.doubanio.com/view/movie_poster_cover/lpst/public/p2397960879.jpg");

        FilmBean filmBean10 = new FilmBean();
        filmBean10.setTitle("掠夺者");
        filmBean10.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2404556021.jpg");

        FilmBean filmBean11 = new FilmBean();
        filmBean11.setTitle("萨利机长");
        filmBean11.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2403319543.jpg");

        FilmBean filmBean12 = new FilmBean();
        filmBean12.setTitle("神奇动物在哪里");
        filmBean12.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2392444121.jpg");

        FilmBean filmBean13 = new FilmBean();
        filmBean13.setTitle("我在故宫修文物");
        filmBean13.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2396361760.jpg");

        FilmBean filmBean14 = new FilmBean();
        filmBean14.setTitle("失心者");
        filmBean14.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2405533771.jpg");

        FilmBean filmBean15 = new FilmBean();
        filmBean15.setTitle("佩小姐的奇幻城堡");
        filmBean15.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2398173791.jpg");

        FilmBean filmBean16 = new FilmBean();
        filmBean16.setTitle("28岁未成年");
        filmBean16.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2402824160.jpg");

        FilmBean filmBean17 = new FilmBean();
        filmBean17.setTitle("有迹可循");
        filmBean17.setImages("http://img7.doubanio.com/view/movie_poster_cover/lpst/public/p2403079835.jpg");
        ...
        final MovieAdapter movieAdapter = new MovieAdapter(getActivity(), films);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                genres.add("爱情");
                filmBean.setGenres(genres);
                filmBean.setImages("http://img7.doubanio.com/view/movie_poster_cover/spst/public/p2390687452.jpg");
                ArrayList countries = new ArrayList<String>();
                countries.add("中国大陆");
                countries.add("香港");
                filmBean.setCountries(countries);
